...
.form-control:focus {
  ...
  border-color: #8080ff;
  outline: 0;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(0, 0, 255, 0.25);
}
...
.btn:not(:disabled):not(.disabled):active:focus, .btn:not(:disabled):not(.disabled).active:focus {
  box-shadow: 0 0 0 0.2rem rgba(0, 0, 255, 0.25), inset 0 3px 5px rgba(0, 0, 0, 0.125);
}
...
.custom-select:focus {
  border-color: #8080ff;
  outline: 0;
  box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(0, 0, 255, 0.25);
}
